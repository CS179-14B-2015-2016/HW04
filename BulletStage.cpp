...
BulletStage::BulletStage(): dimension(vec2f(490, 690)), position(vec2f(5, 5) + dimension/2.0f), player(this), enemy(this) ,senemy(this), timer(0){
...
void BulletStage::render(sf::RenderWindow& window) const {
    ...
    if(timer > 30)senemy.draw(window);
}
