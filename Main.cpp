...
//		Entity::getPos(void update(float dt))
	}
}
...
void EntityManager::initialize() {
	...
	enemies.push_back(new Enemy(sf::Vector2f(window_width / 2, window_height / 4), new ShootStraight(FiringRates::ENEMY, Colors::EBULLET), new RotateConstantly(RotationalSpeeds::ENEMYSTRAIGHT)));
	enemies.push_back(new Enemy(sf::Vector2f(window_width / 2, window_height / 4), new ShootStraight(FiringRates::ENEMY, Colors::EBULLET), new RotateConstantly(RotationalSpeeds::ENEMYSTRAIGHT)));
	enemies.push_back(new Enemy(sf::Vector2f(window_width / 2, window_height / 4), new ShootStraight(FiringRates::ENEMY, Colors::EBULLET), new RotateConstantly(RotationalSpeeds::ENEMYCURVE)));
}