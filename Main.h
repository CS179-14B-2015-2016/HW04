...
namespace RotationalSpeeds {
	const auto ENEMYCURVE = 50.0f;
	const auto ENEMYSTRAIGHT = 0.0f;
}
...
/*class ShootBack : public ShootBehavior {
public:
	ShootBack(float firing_rate, const sf::Color& bullet_color) : ShootBehavior(firing_rate, bullet_color) {}
	void behave(sf::CircleShape& form, float dt) override;
};*/
